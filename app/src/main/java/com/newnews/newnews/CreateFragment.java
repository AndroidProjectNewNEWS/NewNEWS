...
public class CreateFragment extends Fragment implements View.OnClickListener {
    ...
    EditText title_create, imgDes_create, content_create, author_create,link_create;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        link_create=rootView.findViewById(R.id.link_create);
                ...
                if (fileUri != null) {
                    ...
                    ref.putFile(fileUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            String url=link_create.getText().toString();
                            String imgUrl = taskSnapshot.getDownloadUrl().toString();
                            Article article = new Article(title, time,author,imgUrl,imgDescription,content,uid,url);
